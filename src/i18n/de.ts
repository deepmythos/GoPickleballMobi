...
export const de: Dict = {
  ...
  "time.from": "Von",
  "time.to": "Bis",
  "time.span": "{from} – {to} · {hours} Std.",
  "time.rangeScore": "Wert für den gesamten Zeitraum: {score} · {verdict}",
  "time.midpointNote": "Detailwerte zur Mitte des Zeitraums: {hour}",
  "time.local": "Ortszeit",
  ...
  "reason.gate.wet": "Zu viel Regen in den letzten 3 Stunden, Platz noch nass → gilt als nicht spielbar.",

  "factor.rain_current": "Aktueller Regen",
  "factor.rain_probability": "Regenwahrscheinlichkeit",
  "factor.rain_3h": "Regen der letzten 3 Stunden",
  ...
  "factor.note.good.rain_3h": "Der Platz ist trocken, da es in den letzten 3 Stunden kaum geregnet hat.",
  "factor.note.bad.rain_3h": "Viel Regen in den letzten 3 Stunden, der Platz kann noch nass sein.",
  ...
  "raw.rain": "Regenmenge",
  "raw.rain3h": "Regen der letzten 3 Stunden",
